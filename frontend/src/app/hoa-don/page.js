...
//       "Người lập": hd.HoTenNV,
//       "Số lượng combo": hd.SoLuongCombo,
//       "Số lượng vé": hd.SoLuongVe,
//     }))
//   );
...
//   const [searchNguoiLap, setSearchNguoiLap] = useState(""); // Added for person who created invoice
...
//       return matchName && matchNguoiLap && matchDate;
//     });
...
//                   value={searchNguoiLap}
//                   onChange={(e) => setSearchNguoiLap(e.target.value)}
//                 />
//               </div>
//               <div>
